...
.trends-header{text-align:center}
.trends-title{font-size:32px;font-weight:800;color:#0f172a}
.filter-bar{display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin:24px 0}
.filter-bar button{padding:10px 18px;border-radius:999px;border:1px solid #e5e7eb;background:#fff!important;color:#0f172a!important;font-weight:700!important;font-size:13px!important;line-height:1;cursor:pointer}
.filter-bar button.active{background:#0f172a!important;color:#fff!important;border-color:#0f172a!important}
...
@media(max-width:768px){.trends-grid{grid-template-columns:1fr}.trends-wrap{padding:20px 16px 140px}}
</style>
<div class="trends-wrap">
<div class="trends-header">
<h1 class="trends-title">지금 가장 많이 보는 금융 키워드 <span style="font-size:12px;background:#fee2e2;color:#dc2626;padding:6px 12px;border-radius:20px;vertical-align:middle">● LIVE</span></h1>
...
<?php if($t['badge']): ?><div class="trend-badge"><?php echo $t['badge']; ?></div><?php endif; ?>
