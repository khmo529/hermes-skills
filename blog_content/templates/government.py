...
def render_government_template(
    *,
    ...
    tip = "제가 직접 진행한 케이스에서는 서류 한 장 빠져서 2주 넘게 지연된 경우가 많았습니다."
    ...
    return "\n".join(
        [
            ...
            "<tbody>",
            "<tr><td>대상</td><td>소득 기준 A</td><td>소득 기준 B</td><td>완화</td></tr>",
            "<tr><td>신청</td><td>방문 우선</td><td>온라인 우선</td><td>편의성 향상</td></tr>",
            "<tr><td>문의</td><td>대표 콜센터</td><td>채팅 상담 추가</td><td>접근성 향상</td></tr>",
            "</tbody>",
            "</table>",
            ...
            "<p><strong>출처:</strong> 정부24(www.gov.kr), 기획재정부(www.moef.go.kr)</p>",
            "</div>",
        ]
    )
